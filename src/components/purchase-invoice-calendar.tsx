...
export function PurchaseInvoiceCalendar({
  ...
  const createUrl = `/purchase-invoice/create?date=${selectedDate}`

  return (
    <div className="flex flex-col gap-4 p-4 md:p-6 lg:p-8 m-4 border rounded-xl shadow-sm bg-background/50">
